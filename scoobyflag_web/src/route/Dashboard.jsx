...
export default function Dashboard() {
    const templates = [
        {
            ...
            "gameMaster": {
                "id": 1,
                "email": "user@user.fr",
                "password": "$2y$13$Z0WXItgEa9exI8mlU6HtNe3ANzAmv0yeBRoa99/.TuuNUpkfbm4kO",
                "pseudo": "user"
            },
            "json": {
                "name": "Sprint 1",
    ...
    return <div className="fond-degrade-dashboard">
        <div className="header">
            ...
            <img src="profile.png" alt="" className="btn-user" onClick={clickUser} />
        </div>
        <div className="main-dashboard">
            ...
            <div className="zone-grise">
                ...
                <div className="detail-config">
                    {selectedConfig == "" ? <div className="config-empty">
